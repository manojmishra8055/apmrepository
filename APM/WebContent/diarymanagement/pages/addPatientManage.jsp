    ...
    <div class="tab-top-border"></div>
		...
		<div id="sourceOfPayment-tab" class="tab-content">
				...
				<table width="100%" class = "boxclientthirdpartycharge" style="font-size: 12px">
					...
					<td>Company Name</td>
					<td align="center">:</td>
					<td><s:select id="typeName" name="typeName" list="thirdPartyTypeNameList" listKey="id" listValue="thirdPartyCompanyName" headerKey="0" theme="simple" headerValue="Select 3rd Party Name"/></td>
					</tr>
					<!--<tr>
