			...
			<div class="form_elements">				
			    <table width="40%" class = "boxclientthirdpartycharge" style="font-size: 12px">
					...
					<tr>
						...
						<td align="center">:</td>
						<td>
							<s:textfield id="occupation" name="occupation" title="Enter Occupation" />
						</td>
					</tr>
					</table>
