...
<div id="login_main" class="main_layout_content">
	<h2 class="title" style="margin-right: 20px">All References List</h2>
	
	<div id="login" class="block_div">
		
					<div class="diaryuser">	
					<a style="text-decoration: none" href="addReferenceMaster" ><input type="button" value="Add" class="buttons"/></a> <br><br>
					</div>
				...
				<table id="results" cellpadding="0" cellspacing="0" class="my-table"  style="width:100%;">
					...
					<s:else>
						There is no Reference found!!
					</s:else>
							
				</table>  			

		<s:form action="referenceMaster" name="paginationForm" id="paginationForm" theme="simple">
				<table align="center">
					<tr>
