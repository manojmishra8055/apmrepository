		...
		<s:form action="updateJobTitleMaster" id="addOccupation_form" theme="simple">
			<div class="form_elements">				
			    <table width="40%" class = "boxclientthirdpartycharge" style="font-size: 12px">
					...
					<col width="30%"/>
					<tr>
						<td>Job Title<span class="reqd-info">*</span></td>
						<td align="center">:</td>
						<td>
							<s:textfield id="jobTitle" name="jobTitle" title="Enter Job Title" />
