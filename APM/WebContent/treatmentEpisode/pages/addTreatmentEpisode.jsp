						...
						<td width="50%">
							<table width="100%">
								...
								<tr>
									...
									<td align="center">:</td>
									<td><input id="treatmentStartDate" class="date-pick dp-applied" type="text"  name="treatmentStartDate"></td>
								</tr>
								<tr>
									<td>Department</td>
									<td align="center">:</td>
					...
					<tr>
						<td colspan="2">
							<table width="100%">
								...
								<tr>
									<td></td>
									<td><input class="buttons" type="submit" value="Save" onclick="closeTreatment();"></td>
