...
<div id="login_main" class="main_layout_content">
	<h2 class="heading" >Edit Third Party</h2>
	<span id="mandatory_message" class="error">Note:Fields marked with asterisk(*) are required.</span> 
	<div id="login" class="block_div">
		
		<span class="error"><s:actionerror id="server_side_error"/></span>
		<s:form action="updateTypeThirdParty" id="thirdPartyType_form" theme="simple">
			    ...
			    <table width="100%" class = "boxclientthirdpartycharge" style="font-size: 12px">
					...
					<tr>
		 			<td>
		 				<table align="center">
		 					<tr>
		 						<td><s:submit value="Update" cssClass="buttons"/></td>
