...
<div id="tab-container">  
	...
	<s:form action="updateDetailsThirdParty" id="registerfrm" theme="simple" >
	...
	<div id="personalDetails-tab" class="tab-content active">
			...
			<s:hidden id = "id" name = "id"/>
		 	...
		 	<tr>
		 	<td align="right">Direct Telephone Line</td>
		 	<td align="center">:</td>
		 	...
		 	<td align="center">:</td>
		 	<td><s:textarea name = "notes" id = "notes" rows="5" cols="24"></s:textarea></td>
		 	</tr>
		 	<tr>
		 	<td align="right">Company Details</td>
		 	<td align="center">:</td>
		 	<td><s:textarea id = "companyDetails" name = "companyDetails" rows="7" cols="24"/></td>
		 	</tr>
		 	</table>
	...
	<div id="contactPreferences-tab" class="tab-content">
		<center>
		  <table width="100%" style="font-size: 12px;">
			...
			<s:submit value="Update" cssClass="buttons"></s:submit>		 	
	</div>
